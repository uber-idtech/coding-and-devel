...
// It asks user to input their name, possessive pronoun, and object pronoun
void intro()
{
	cout << "This is a tale is filled with mystery and deceit. Be observant, and make wise choices!" << endl;
